...
const CommentItem = ({ comment, blogId }) => {
 ...
 // console.log("like", reactToComment);
  ...
  return (
    <div
      className={`yt-comment-container ${comment.parentCommentId ? "is-reply" : ""}`}
    >
      {/* LEFT COLUMN: AVATAR */}
        ...
        {isEditing ? (
          <div className="edit-mode-container">
            ...
            <div className="yt-button-row">
              <button className="yt-text-btn red" onClick={handleEditSubmit}>
                Save
              </button>
              <button
...
/>
 {replyError && (
            ...
            <div className="yt-button-row">
              <button className="yt-text-btn red" onClick={handleReplySubmit}>
                Reply
              </button>
              <button
                className="yt-text-btn"
